  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
          ...
          A decentralised logistics application that keeps track of product whereabouts at all shipping points using blockchain technology. Customers at the consumer end may easily scan the QR CODE of items to obtain detailed information on the origin of that product, enabling them to only buy authentic and high-quality products.
            </p>
            <br><br>
