...
<html lang="en">
  <head>
    ...
    <title>RFPS - Scan Shipments</title>
            ...
            <div class="greyarea">
                ...
                <form id="form2" autocomplete="off">
                    ...
                    <div class="formitem">
                       ...
                       <input type="hidden" class="forminput" id="user" value=<?php echo $_SESSION['role']; ?> required>
...
var contractAddress ='0x00A460dA4C8C21C1AC9B65D75b3E4AaC25Be8185';
      // Set the Contract
